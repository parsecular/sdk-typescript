...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['PARSEC_API_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['PARSEC_API_LOG'] or 'warn' if it isn't set.
   */
...
export class ParsecAPI {
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('PARSEC_API_LOG'), "process.env['PARSEC_API_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('PARSEC_API_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  static ParsecAPI = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static ParsecAPIError = Errors.ParsecAPIError;
